...
import dev.simplified.skyblock.SkyBlockData;
import dev.simplified.skyblock.common.Rarity;
...
public class Reforge implements JpaModel {
    ...
    public static class Substitute {
        ...
        public @NotNull Optional<Stat> getStat() {
            ...
            return dev.simplified.skyblock.SkyBlockData.getRepository(Stat.class).findFirst(Stat::getId, this.id);
        }
